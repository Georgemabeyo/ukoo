...
// Hakikisha mtu amelogin, vinginevyo tambua kama unataka kumrudisha login page
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    if ($first_name == '' || $last_name == '') {
        ...
        $sql = "UPDATE family_tree SET first_name=$1, middle_name=$2, last_name=$3, dob=$4, gender=$5, marital_status=$6, phone=$7, email=$8 WHERE id=$9";
        $params = [$first_name, $middle_name, $last_name, $dob, $gender, $marital_status, $phone, $email, $id];
...
<div class="container my-5">
    ...
    <?php if ($editEntry): ?>
    <form method="post" action="edit_member.php?id=<?= $editEntry['id'] ?>">
